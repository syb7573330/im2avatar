    ...
    with tf.Session(config=config) as sess:
      ...
      for epoch in range(TRAIN_EPOCHS):
        ...
        for batch_idx in range(val_batches):
          imgs, vols_flow, vols_clr = dataset_.next_flow_batch(batch_idx * BATCH_SIZE, BATCH_SIZE, vol_dim=VOL_DIM,  process="val")
          feed_dict = {img_pl: imgs, vol_clr_pl: vols_clr, vol_flow_pl: vols_flow, is_train_pl: False}
